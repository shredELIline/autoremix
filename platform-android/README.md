...
Android 10+ (`minSdk 29`) app using Kotlin, Compose, WorkManager, Media3, and an Oboe/AAudio output path. The retained Java provider performs local MediaStore scan, MediaCodec decode, deterministic analysis/separation, and scene preparation.
